...
| [`mule-lint`](https://github.com/Avinava/mule-lint) | [`@sfdxy/mule-lint@1.30.0`](https://registry.npmjs.org/@sfdxy%2Fmule-lint/1.30.0) | Canonical Mule standards, static analysis, XML formatting, and RAML/OAS validation | None |
...
| `mule-build` | Primary | Static and security gate | No — platform actions hand off to `mule-ops` |
...
```json
{
  "mcpServers": {
    ...
    "mule-lint": {
      "command": "npx",
      "args": ["-y", "@sfdxy/mule-lint@1.30.0", "mcp"]
    }
  }
}
```
