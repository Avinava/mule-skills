...
Six skills, shared and host-neutral. Claude Code loads them from the plugin; every other host reads
...
| [`mule-development`](https://github.com/Avinava/mule-skills/tree/main/skills/mule-development) | Mule XML, DataWeave, connectors, error handling, queues, batch, configuration, and MUnit changes | Implemented source change with proportionate validation |
