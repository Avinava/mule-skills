...
This runbook was split so each install path has its own document.

| You are | Go to |
| --- | --- |
| New to Mule Skills | [docs/getting-started.md](docs/getting-started.md) |
| An AI agent asked to install these skills | [docs/agent-install.md](docs/agent-install.md) |
...
| Looking for task examples and approval boundaries | [docs/workflows.md](docs/workflows.md) |
