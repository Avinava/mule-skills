...
Classes A–E and mandatory cross-cutting gates defined by `mule-development`. For change review,
focus on changed behavior and directly affected dependencies. For project and readiness reviews,
cover all domains and disclose any area not inspected.
